...
class postdata_gui:
    ...
    def main(self):
        ...
        self.positions_sframe1.grid_rowconfigure(1, weight=1)
        self.positions_sframe1.grid_rowconfigure(2, weight=1)
        self.positions_sframe1.grid_rowconfigure(3, weight=1)
        self.positions_sframe1.grid_rowconfigure(4, weight=1)
        self.positions_sframe1.grid_rowconfigure(5, weight=1)
        self.positions_sframe1.grid_rowconfigure(6, weight=1)
        self.positions_sframe1.grid_rowconfigure(7, weight=1)
        self.positions_sframe1.grid_rowconfigure(8, weight=1)
        ...
        self.positions_sframe2.grid_rowconfigure(0, weight=1)
        self.positions_sframe2.grid_rowconfigure(1, weight=1)
        self.positions_sframe2.grid_rowconfigure(2, weight=1)
        self.positions_sframe2.grid_rowconfigure(3, weight=1)
        self.positions_sframe2.grid_columnconfigure(0, weight=1)
        self.positions_sframe2.grid_columnconfigure(1, weight=1)
        ...
        self.ga_mframe.grid_rowconfigure(12, weight=1)
        self.ga_mframe.grid_rowconfigure(13, weight=1)
        ...
        self.exec_mframe.grid_rowconfigure(0, weight=1)
        self.exec_mframe.grid_rowconfigure(1, weight=1)
        self.exec_mframe.grid_rowconfigure(2, weight=1)
        self.exec_mframe.grid_rowconfigure(3, weight=1)
        self.exec_mframe.grid_rowconfigure(4, weight=1)
        self.exec_mframe.grid_rowconfigure(5, weight=1)
        self.exec_mframe.grid_rowconfigure(6, weight=1)
        self.exec_mframe.grid_rowconfigure(7, weight=1)
        self.exec_mframe.grid_rowconfigure(8, weight=1)
        # self.exec_mframe.grid_rowconfigure(9, weight=1)
        # self.exec_mframe.grid_rowconfigure(10, weight=1)
        # self.exec_mframe.grid_rowconfigure(11, weight=1)
        self.exec_mframe.grid_columnconfigure(0, weight=1)
        self.exec_mframe.grid_columnconfigure(1, weight=1)
        self.exec_mframe.grid_columnconfigure(2, weight=1)
