...
class postdata_gui:
    ...
    def main(self):
        ...
        self.line1 = ttk.Separator(self.positions_sframe1).grid(row=2,column=0,columnspan=4,sticky='nsew')
        self.line2 = ttk.Separator(self.positions_sframe1).grid(row=2,column=1,rowspan=5,sticky='nsew')
